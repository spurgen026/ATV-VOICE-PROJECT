...
def test_cloud_chat_unavailable_response_covers_every_language():
    assert set(config.CLOUD_CHAT_UNAVAILABLE_RESPONSE) == SUPPORTED_LANGUAGES
...
def test_no_response_table_has_an_empty_string():
    ...
    tables = [
        ...
        config.CLOUD_CHAT_UNAVAILABLE_RESPONSE,
        small_talk.THANKS_RESPONSE,
        small_talk.CAPABILITY_RESPONSE,
        small_talk.IDENTITY_RESPONSE,
        small_talk.GREETING_RESPONSE,
